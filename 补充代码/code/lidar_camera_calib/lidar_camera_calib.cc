...
void LidarCameraCalib::Project()
{
    ...
    // assert(static_cast<bool>(object_points[0].x == image_points[0].x));
    std::cout << (object_points[0].x == image_points[0].x) << std::endl;
    std::cout << "diff x: " << object_points[0].x - image_points[0].x << std::endl;
    std::cout << "diff y: " << object_points[0].y - image_points[0].y << std::endl;
    std::cout << "diff size: " << object_points.size() - image_points.size() << std::endl;
