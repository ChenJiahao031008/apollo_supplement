...
- [实车标定实践](#实车标定实践 )
  ...
  - [1 Camera内参标定](#1-camera内参标定 )
    - [1.1 图像采集](#11-图像采集 )
    - [1.2 开始标定](#12-开始标定 )
    - [1.3 内参标定输出](#13-内参标定输出 )
  - [2 Lidar-Camera标定](#2-lidar-camera标定 )
    - [2.1 数据采集](#21-数据采集 )
    - [2.2 数据解析](#22-数据解析 )
      - [2.2.1 激光数据解析](#221-激光数据解析 )
      - [2.2.2 图像数据解析](#222-图像数据解析 )
    - [2.3 外参标定](#23-外参标定 )
    - [2.4 外参标定输出](#24-外参标定输出 )
  - [3 Lidar-INS 标定](#3-lidar-ins-标定 )
    - [3.1 数据采集](#31-数据采集 )
    - [3.2 数据解析](#32-数据解析 )
    - [3.3 标定外参](#33-标定外参 )
    - [3.4 外参标定输出](#34-外参标定输出 )
  - [4 油门刹车标定](#4-油门刹车标定 )
      - [4.1 油门数据采集](#41-油门数据采集 )
      - [4.2 油门刹车标定](#42-油门刹车标定 )
...
<img src="实车标定实践.assets/2022-04-02 21-17-27 的屏幕截图.png" style="zoom:63%;" />
