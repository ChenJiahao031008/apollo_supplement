...
1. 添加数据解析脚本
   ...
   - 运行数据解析脚本文件
     ...
     <img src="实车标定实践.assets/2022-03-17 16-00-46 的屏幕截图.png" alt="2022-03-17 16-00-46 的屏幕截图" style="zoom:80%;" />
...
4. **执行数据收集程序**
   ...
   <img src="实车标定实践.assets/2022-03-12 20-50-42 的屏幕截图-16492116984952.png" style="zoom: 80%;" />
