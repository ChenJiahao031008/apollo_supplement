...
在`补充代码/calib_tools_docker/workspace/`目录下克隆项目至本地：
...
+ 如果图像大小无法缩放，可在`calibration_algorithm/lidar_camera_calib/lidar_camera_calib.cc`中第149行（`LidarCameraCalib::Project`函数末尾）添加：
